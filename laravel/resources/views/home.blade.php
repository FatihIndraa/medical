...
@section('konten')
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://source.unsplash.com/1600x600/?hospital" class="d-block w-100 img-fluid" alt="Hospital">
            </div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <img src="https://source.unsplash.com/400x300/?hospital" class="card-img-top" alt="Hospital Image">
                    <div class="card-body">
